...
export declare function printTemplateExpression(path: AstPath<Expression & {
    comments?: Comment[];
}>, print: InternalPrintFun, templateLiteral: TemplateLiteral, index: number, tabWidth: number): builders.Group;
export declare function printTemplateExpressions(path: AstPath<TemplateLiteral>, print: InternalPrintFun, options?: Options): builders.Group[];
export declare function simpleRehydrateDoc(doc: Doc, placeholderRegex: RegExp, expressionDocs: Doc[], 
/**
 ...
 */
newlineHandling?: false | "hardline" | "literalline"): builders.Doc[] | builders.DocCommand;
